...
import com.company.user.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.company.user.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class EmployeeResource {
    ...
    private static final String ENTITY_NAME = "rafEmployee";
