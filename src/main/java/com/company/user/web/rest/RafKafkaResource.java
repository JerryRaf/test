...
@RestController
@RequestMapping("/api/raf-kafka")
public class RafKafkaResource {

    private final Logger log = LoggerFactory.getLogger(RafKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public RafKafkaResource(KafkaProperties kafkaProperties) {
