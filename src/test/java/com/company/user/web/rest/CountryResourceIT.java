...
import com.company.user.domain.Country;
import com.company.user.repository.CountryRepository;
import com.company.user.repository.search.CountrySearchRepository;
import com.company.user.service.CountryService;
...
public class CountryResourceIT {
     ...
     *
     * @see com.company.user.repository.search.CountrySearchRepositoryMockConfiguration
     */
    @Autowired
