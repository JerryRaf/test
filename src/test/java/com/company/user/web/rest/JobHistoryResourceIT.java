package com.company.user.web.rest;

import com.company.user.RafApp;
import com.company.user.domain.JobHistory;
import com.company.user.repository.JobHistoryRepository;
import com.company.user.repository.search.JobHistorySearchRepository;
import com.company.user.service.JobHistoryService;
import com.company.user.web.rest.errors.ExceptionTranslator;
...
import static com.company.user.web.rest.TestUtil.createFormattingConversionService;
...
import com.company.user.domain.enumeration.Language;
/**
 * Integration tests for the {@link JobHistoryResource} REST controller.
 */
@SpringBootTest(classes = RafApp.class)
public class JobHistoryResourceIT {
    ...
    /**
     * This repository is mocked in the com.company.user.repository.search test package.
     *
     * @see com.company.user.repository.search.JobHistorySearchRepositoryMockConfiguration
     */
    @Autowired
