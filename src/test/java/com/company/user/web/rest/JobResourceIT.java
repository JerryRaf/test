...
import com.company.user.domain.Job;
import com.company.user.repository.JobRepository;
import com.company.user.repository.search.JobSearchRepository;
...
public class JobResourceIT {
     ...
     *
     * @see com.company.user.repository.search.JobSearchRepositoryMockConfiguration
     */
    @Autowired
