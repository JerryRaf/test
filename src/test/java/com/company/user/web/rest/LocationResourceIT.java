...
import com.company.user.domain.Location;
import com.company.user.repository.LocationRepository;
import com.company.user.repository.search.LocationSearchRepository;
import com.company.user.service.LocationService;
...
public class LocationResourceIT {
     ...
     *
     * @see com.company.user.repository.search.LocationSearchRepositoryMockConfiguration
     */
    @Autowired
