...
import com.company.user.domain.Region;
import com.company.user.repository.RegionRepository;
import com.company.user.repository.search.RegionSearchRepository;
import com.company.user.service.RegionService;
...
public class RegionResourceIT {
     ...
     *
     * @see com.company.user.repository.search.RegionSearchRepositoryMockConfiguration
     */
    @Autowired
