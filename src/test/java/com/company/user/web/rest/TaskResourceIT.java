...
import com.company.user.repository.TaskRepository;
import com.company.user.repository.search.TaskSearchRepository;
import com.company.user.service.TaskService;
...
public class TaskResourceIT {
     ...
     *
     * @see com.company.user.repository.search.TaskSearchRepositoryMockConfiguration
     */
    @Autowired
